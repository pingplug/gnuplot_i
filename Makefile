...
tests:		test/anim test/example test/png
...
test/png:	test/png.c gnuplot_i.o
	$(CC) $(CFLAGS) $(LIB) -o test/png test/png.c gnuplot_i.o

clean:
	$(RM) gnuplot_i.o test/anim test/example test/png
